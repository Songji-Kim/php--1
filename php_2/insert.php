...
$stmt = $pdo->prepare("INSERT INTO hajimenoippo_an_table(id, companyname, name, department,mail, terms, privacy, date)
                        VALUES(NULL, :companyname,:name, :mail, :terms, :privacy, sysdate())");
...
$stmt->bindValue(':terms', $terms, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':privacy', $privacy, PDO::PARAM_STR);  //Integer（数値の場合 PDO::PARAM_INT)
